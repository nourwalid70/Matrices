...
choice_option = menu('choose an option','Scaling with ratio along the x-axis and y-axis, respectively.','Reflection in the x-axis.','Reflection in the y-axis.','Reflection in the straight line y = x.',' Reflection in the straight line y = - x.','Rotation about the origin of the polygon by an angle ? in the clockwise direction.','Translation of the polygon origin to a new point (x0 , y0).');
[z] = translate_to_origin(x(1),y(1));
Transformation_matrix= z;
